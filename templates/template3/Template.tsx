  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-5xl mx-auto px-4 py-8 sm:px-6 lg:px-8">
        ...
        <div className="bg-gray-100 rounded-xl p-1 flex mb-8 overflow-x-auto">
          <a
            href="#about"
          ...
          <a href="#experience" className="flex-1 py-2 px-4 text-center font-medium text-gray-700 hover:text-gray-900">
            Experience
          </a>
          <a href="#education" className="flex-1 py-2 px-4 text-center font-medium text-gray-700 hover:text-gray-900">
            Education
          </a>
          <a href="#skills" className="flex-1 py-2 px-4 text-center font-medium text-gray-700 hover:text-gray-900">
            Skills
          </a>
          <a href="#projects" className="flex-1 py-2 px-4 text-center font-medium text-gray-700 hover:text-gray-900">
            Projects
          </a>
        </div>
        ...
        <section id="skills" className="mb-12">
          ...
          {profile.skills && profile.skills.length > 0 ? (
            ...
            <div className="bg-white rounded-2xl shadow-sm p-6 text-center text-gray-500">No skills added yet.</div>
          )}
        </section>
        ...
        <section id="projects" className="mb-12">
          ...
          {profile.projects && profile.projects.length > 0 ? (
            ...
            <div className="bg-white rounded-2xl shadow-sm p-6 text-center text-gray-500">No projects added yet.</div>
          )}
        </section>
      </div>
